...
export default function Sidebar() {
  ...
  return (
    <div
      ref={sidebarRef}
      className={`${isSideBarOpen === true ? "translate-x-[0] opacity-100 duration-300 ease-in-out" : "translate-x-[-100%] opacity-0 duration-300 ease-in-out"} fixed top-0 z-[1000] h-full w-full min-w-[320px] max-w-[415px] bg-header_bg_second text-header_text large-screen:hidden large-screen:opacity-0`}
    >
