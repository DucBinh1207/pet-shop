...
import TabContentItem from "./_components/tab-content-item";
...
export default function TabContent({ id, tab }: props) {
  ...
  return (
    <div
      className={cn(
        ...
        {
          "hidden animate-fade_out opacity-0": !tab,
        },
      )}
      id={id}
    >
      ...
      <div className="relative flex w-[calc(100%-463px)] flex-col small-screen:w-full">
        ...
        <div className="hidden opacity-0 hover:block hover:opacity-100 peer-hover:block peer-hover:opacity-100">
          <div className="product-suggestion-swiper-button-prev absolute left-[-27px] top-[50%] h-[54px] w-[54px] translate-y-[-50%] cursor-pointer rounded-[50%] bg-white bg-arrow_prev bg-[length:40px_40px] bg-center bg-no-repeat p-[17.5px] text-primary shadow-item_next after:content-['']"></div>

          <div className="product-suggestion-swiper-button-next absolute right-[-27px] top-[50%] h-[54px] w-[54px] translate-y-[-50%] cursor-pointer rounded-[50%] bg-white bg-arrow_next bg-[length:40px_40px] bg-center bg-no-repeat p-[17.5px] text-primary shadow-item_next after:content-['']"></div>
        </div>
      </div>
    </div>
  );
