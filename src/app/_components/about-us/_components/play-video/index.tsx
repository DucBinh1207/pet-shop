...
export default function PlayVideo() {
  ...
  return (
    <>
      ...
      {play && (
        <>
          <div className="fixed left-[5vw] top-[5vh] z-[90] h-[90vh] w-[90vw] p-[50px] small-screen:left-auto small-screen:top-[50%] small-screen:h-0 small-screen:translate-y-[-50%] small-screen:pb-[56.25%]">
            <iframe
          ...
          <div
            className={cn(
              ...
              {
                "block opacity-100": play,
                "hidden opacity-0": !play,
              },
            )}
          ></div>
        </>
